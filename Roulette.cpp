            ...
            switch (playOnNumOrCol){
                ...
                case 1:
                    ...
                    if (insertedNumber == checkNumber){
                        ...
                        cout << "" << endl;
                        cout << "You played on "<< insertedNumber << " and the number on the wheel were " << checkNumber << " so you won!" << endl;
                        ...
                        totalWinToday -= bet;
                        cout << "" << endl;
                        cout << "You played on "<< insertedNumber << " and the number on the wheel were " << checkNumber << " so you unfortunately lost!" << endl;
